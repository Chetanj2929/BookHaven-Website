// ---- Security: HTML escape utility (prevents XSS) ----
    ...
    function toggleDarkMode() {
      ...
      showNotification(isDark ? 'Dark mode enabled 🌙' : 'Light mode enabled ☀️', 'info');
    }
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      document.querySelectorAll('[data-action]').forEach(el => {
        el.addEventListener('click', (e) => {
          ...
          else if (action === 'wishlist') { showNotification('Wishlist coming soon! 💖', 'info'); }
          else if (action === 'settings') { showNotification('Settings coming soon! ⚙️', 'info'); }
        });
      });
